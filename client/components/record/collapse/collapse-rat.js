        ...
        <div className="collapse show" id="collapse_rat">
          <div className="card card-body collapse_card">
            <div className="container-fluid d-flex p-0">
              <div className="ms-2 me-5 d-flex">
                <div className="d-flex flex-column">
                  <p className="mb-0 chart-title">平均熱量攝取</p>
                  <p className="chart-subtitle" id="food_cal">
              ...
              <div className="d-flex">
                <div className="d-flex flex-column">
                  <p className="mb-0 chart-title">平均蛋白質攝取</p>
                  <p className="chart-subtitle" id="food_protein">
            ...
            <div className="container-fluid d-flex p-0 mt-3">
              <div className="ms-2 me-5 d-flex">
                <div className="d-flex flex-column">
                  <p className="mb-0 chart-title">平均脂肪攝取</p>
              ...
              <div className="d-flex">
                <div className="d-flex flex-column">
                  <p className="mb-0 chart-title">平均碳水化合物攝取</p>
